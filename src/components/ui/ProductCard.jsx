...
export default function ProductCard({ product }) {
  return (
    <CardTilt className="h-full">
      <article className="flex h-full flex-col overflow-hidden rounded-2xl border border-gold/20 bg-cream shadow-lg shadow-navy/5">
        ...
        <div className="flex flex-1 flex-col p-5">
          ...
          <p className="mt-3 font-semibold text-gold">{formatInr(totalWithGst(product.price))}</p>
